...
//const { convert }=require ("../lib/ezgif-convert.js");

const axios =require('axios');
const fs = require('fs')
const { FormData,
    Blob }=require('formdata-node');
    ...
    try {
        return await convert({
            ...
            ...(isUrl ? {
                ...
                filename: randomBytes + "." + (await FileType.fromBuffer(data)).ext
            })
        });
    } catch (error) {
    ...
    try {
        return await convert({
            ...
            ...(isUrl ? {
                ...
                file: new Blob([source]),
                filename: randomBytes + "." + (await FileType.fromBuffer(source)).ext
            })
        });
    } catch (pngError) {
